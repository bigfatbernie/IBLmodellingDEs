...
\begin{itemize}
	...
	\begin{itemize}
		\item Put about 8 ODEs on the board
...
\begin{itemize}
	...
	\item Solve first core exercise for this lesson/module
\end{itemize}
...
\begin{goals}
	...
	Let students know that they should solve this exercise at home before class.
	
	In class, quickly solve it.
\end{goals}	
\end{annotation}
\question Consider the slope field from the first video of the module.
...
\begin{itemize}
	\item Read textbook
	\item Read the first core exercise and solve steps 1 (define problem) and 2 (create a mind map)
\end{itemize}
...
\Heading{Objectives}
	\begin{itemize}
		\item HERE HERE HERE HERE HERE HERE HERE
		\item Identify a Separable ODE
		\item Know how to solve a Separable ODE
		\item Identify a first-order linear ODE
		\item Know how to solve a first-order linear ODE: Method of the Integrating Factor
...
\end{goals}	
\end{annotation}
\question Consider the example in the video:
...
\end{goals}	
\end{annotation}
\question Consider the ODE from the video in the module.

\begin{center}
	\includegraphics*[width=200pt]{images/module14-preclass.png}
\end{center}
