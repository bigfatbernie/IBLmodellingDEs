...
\begin{itemize}
	\item Ask students to prepare the next core exercise before class.
	\item They should combine their mind map(s) and assumptions from the previous lessons and come up with an idea of a model to discuss with their classmates in lecture.
	\item There won't be enough time in class to finish the question if  students don't prepare in advance.
\end{itemize}
