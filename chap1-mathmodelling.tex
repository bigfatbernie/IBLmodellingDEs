...
\begin{module}{Defining the Problem}
	...
	\input{modules/module1-define.tex}
	\input{modules/module1-define-exercises.tex}
\end{module}
...
\begin{module}{Building a mind map}
	...
	\input{modules/module2-mindmap.tex}
	\input{modules/module2-mindmap-exercises.tex}
\end{module}
...
\begin{module}{Making assumptions}
	...
	\input{modules/module3-assumptions.tex}
	\input{modules/module3-assumptions-exercises.tex}
\end{module}
...
\begin{module}{Construct a model}
	...
	\input{modules/module4-model.tex}
	\input{modules/module4-model-exercises.tex}
\end{module}
...
\begin{module}{Model Assessment}
	...
	\input{modules/module5-assessment.tex}
	\input{modules/module5-assessment-exercises.tex}
\end{module}
...
\begin{module}{Putting it all together}
	...
	\input{modules/module6-report.tex}
	\input{modules/module6-report-noexercises.tex}
\end{module}
