\emph{Reference.} How to measure influence and impact, ICM 2014
...
\begin{emphbox}[]
In fact a whole website $\bigg($\url{https://oakland.edu/enp} \qrcode[height=0.35in]{https://oakland.edu/enp} $\ \bigg)$ is devoted to the work of Erd{\"o}s and his collaborators. On this site, we were able to extract a \emph{database} $\bigg($\url{https://uoft.me/erdos} \qrcode[height=.35in]{https://uoft.me/erdos}$\ \bigg)$ which contains the list of mathematicians, mathematicians who have a Erd{\"o}s number $= 1$. Each line of this database contains:
\begin{itemize}
...
\begin{center}
\begin{tabular}{ccc}
\framebox{\begin{tikzpicture}[scale=0.465]
...
\hfill ``Popularity contest'' is a collaboration with Yvan Saint-Aubin.
