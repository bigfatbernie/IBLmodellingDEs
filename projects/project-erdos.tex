...
\begin{emphbox}[]
In fact a whole website -- \url{https://oakland.edu/enp} -- is devoted to the work of Erd{\"o}s and his collaborators. On this site, we were able to extract a \textbf{\color{Green}database} $\bigg($\url{https://uoft.me/erdos} \qrcode[height=.35in]{https://uoft.me/erdos}$\ \bigg)$ which contains the list of mathematicians, mathematicians who have a Erd{\"o}s number $= 1$. Each line of this database contains:
\begin{itemize}
