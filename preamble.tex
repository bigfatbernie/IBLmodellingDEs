...
\begin{tikzpicture}
    ...
    \draw[postaction={decorate}] (0,0) arc (270:345:0.5);
    \end{scope}
\end{tikzpicture}
}
...
\begin{tikzpicture}
    ...
    \draw[postaction={decorate}] (0,0) arc (155:90:0.5);
    \end{scope}
\end{tikzpicture}
}
...
\begin{tikzpicture}
    ...
    \draw[postaction={decorate}] (0,0) arc (90:15:0.5);
    \end{scope}
\end{tikzpicture}
}
...
\begin{tikzpicture}
    ...
    \draw[postaction={decorate}] (0,0) arc (195:270:0.5);
    \end{scope}
\end{tikzpicture}
}
