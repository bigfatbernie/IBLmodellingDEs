...
\begin{itemize}
	...
	\hfill \url{https://www.geogebra.org/m/KqNV7eHB} \hfill \qrcode{https://www.geogebra.org/m/KqNV7eHB}
	
	\item WolframAlpha slope field of the same model:

	\hfill \url{https://uoft.me/modelling-sys-wa} \hfill \qrcode{https://uoft.me/modelling-sys-wa}

	\item WolframAlpha stream plot of the same model:

	\hfill \url{https://uoft.me/modelling-sys-wa2} \hfill \qrcode{https://uoft.me/modelling-sys-wa2}
\end{itemize}
