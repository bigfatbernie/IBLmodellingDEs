...
The graphs in the example above are graphs of one specific solution. 
...
Also observe that $\vec{r}(t) = \begin{bmatrix}0 \\ 0\end{bmatrix}$ is a solution of the system, so this system has an equilibrium solution.
